...
class Hj_social_bookmarks {
	...
	// --------------------------------------------------------------------
  	...
  	public function __construct() {
    	...
    	$current_url = urlencode(reduce_double_slashes(current_url() . $query_string));
		...
		if(isset($title) && $title != '' && isset($sites) && $sites != '') {
			...
			$social_sites = Array(
				...
				'Bebo' => Array(
					'short_name' => 'bebo',
					'url' => 'http://www.bebo.com/c/share?Url=' . $current_url . '&amp;Title=' . $title
				),
				...
				'DesignFloat' => Array(
					...
					'url' => 'http://www.designfloat.com/submit.php?url=' . $current_url
				),
				...
				'eKudos' => Array(
					'short_name' => 'ekudos',
					'url' => 'http://www.ekudos.nl/artikel/nieuw?url=' . $current_url . '&amp;title=' . $title . '&amp;desc=' . $excerpt
				),
				...
				'Hyves' => Array (
					'short_name' => 'hyves',
					'url' => 'http://www.hyves-share.nl/button/tip/?tipcategoryid=12&amp;rating=5&amp;title=' . $title . '&amp;body=' . $excerpt . ' [url=' . $current_url. ']' . $current_url . '[/url]',
					'height' => '520',
					'width' => '570'
				),
				...
				'Messenger' => Array(
					...
					'url' => 'http://profile.live.com/badge?url=' . $current_url. '&amp;title=' . $title . '&amp;description=' . $excerpt
				),
				...
				'Posterous' => Array(
					...
					'url' => 'http://posterous.com/share?linkto=' . $current_url . '&amp;title=' . $title . '&amp;selection=' . $excerpt
				),
				...
				'Technorati' => Array(
					...
					'url' => 'http://technorati.com/faves?add=' . $current_url
				),
				...
				'Yahoo' => Array(
					'short_name' => 'yahoo',
					'url' => 'http://bookmarks.yahoo.com/toolbar/savebm?opener=tb&amp;u=' . $current_url . '&amp;t=' . $title . '&amp;d=' . $excerpt,
